...
if part2 == "Y":
    statistics.append(sentimentvalue)
    statistics.append(greenpercent)
    statistics.append(redpercent)
    statistics.append(greenbulls)
    statistics.append(redbears)
    statistics.append(len(processedtotalword))
    statistics.append(len(excludedlst))
    print(statistics)
    pass
else:
